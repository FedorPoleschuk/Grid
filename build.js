function Build(settings, patterns) {
  ...
  resources.mixin = require("./components/Mixin.js");
  resources.media = require("./components/Media.js");
  resources.helpers = require("./components/Helpers.js");
  resources.size = require("./components/Size.js");
  resources.shift = require("./components/Shift.js");
  resources.styles = require("./components/Styles.js");
  resources.replaces = require("./components/Replaces.js");

  let base = require("./components/Base.js");
  let globalMediaCondition = settings.mobileFirst ? "min-width" : "max-width";

  let str = "";

  str += "{{var}}columns{{=}}" + resources.settings.columns + "{{;}}\n";
  str += "{{var}}atom{{=}}calc(100% / {{var}}columns){{;}}\n";
  ...
  let urow = new resources.mixin(resources.patterns.mixin, resources.settings.mixinNames.uRowFlex, "{{var}}offset", emptyMedia.wrap(uRowCommands));
  str += urow.render();
  str += "\n\n";
  ...
  let ucol = new resources.mixin(resources.patterns.mixin, resources.settings.mixinNames.uColumn, "{{var}}offset", emptyMedia.wrap(uColCommands));
  str += ucol.render();
  str += "\n\n";
  ...
  let usize = new resources.mixin(resources.patterns.mixin, resources.settings.mixinNames.uSize, "{{var}}n, {{var}}columns, {{var}}offset", emptyMedia.wrap(uSizeCommands));
  str += usize.render();
  str += "\n\n";
